...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.source           = { :git => 'https://github.com/ingedgarmorales/facephi-ios-framework-pod.git', :tag => s.version.to_s }
  #s.source           = { :path => '.'}

  s.ios.deployment_target = '13.0'
  s.swift_version = '4.2'
  s.source_files = 'FWFaceAuth/Classes/**/*.swift'
  s.vendored_frameworks = 'FWFaceAuth/Frameworks/Microblink.framework', 'FWFaceAuth/Frameworks/FPBExtractoriOS.framework', 'FWFaceAuth/Frameworks/FPhiWidgetCore.framework', 'FWFaceAuth/Frameworks/FPhiWidgetSelphi.framework', 'FWFaceAuth/Frameworks/FPhiSelphIDWidgetiOS.xcframework', 'FWFaceAuth/Frameworks/ZipZap.xcframework'
  s.resource_bundles = {
