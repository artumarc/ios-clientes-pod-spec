...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  #s.source           = { :git => 'https://github.com/Profuturo-Afore/ios-facephi-framework-pod.git', :tag => s.version.to_s }
  s.source           = { :git => 'https://github.com/artumarc/ios-facephi-framework-pod.git', :tag => s.version.to_s }
  #s.source           = { :path => '.'}
  ...
  s.resource_bundles = {
     'FWFaceAuth' => "FWFaceAuth/**/*.{xib,strings,xcassets,zip,json,ttf,xcdatamodeld}"
  }
