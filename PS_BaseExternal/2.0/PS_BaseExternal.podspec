...
spec.source       = { :http => 'http://nexus-devsecopsms.apps.paasprofuturo-d.r6b1.p1.openshiftapps.com/repository/Pods/com/profuturo/procesar/PS_BaseExternal.framework/2.0/PS_BaseExternal.framework-2.0.zip' }
