...
spec.source       = { :http => 'http://nexus3-nexusios.apps.paasprofuturo-d.r6b1.p1.openshiftapps.com/repository/Pods/com/profuturo/com/PS_Core.framework/1.0/PS_Core.framework-1.0.zip' }
