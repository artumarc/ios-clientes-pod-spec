...
spec.source       = { :http => 'http://Pods:pods@nexus-admin.apps.paasprofuturo-d.r6b1.p1.openshiftapps.com/repository/Pods/com/profuturo/facephi/ZipZap/2.1.8/ZipZap-2.1.8.zip' }
